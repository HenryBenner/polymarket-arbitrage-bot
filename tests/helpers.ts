...
export function testConfig(overrides: Partial<BotConfig> = {}): BotConfig {
  return {
    ...
    ladderV14RepairPreserveSeconds: 0,
    ladderV14LiquiditySizing: false,
    ladderV14ValueRepair: false,
    ladderV14RepairExitMargin: 0.005,
    ...
    ladderV14GuardMinShares: 100,
    ladderV14GuardGraceSeconds: 60,
    ladderV14GuardAgedAdverse: 0.01,
    ladderV14MaxSettlementShares: 50,
    ladderV14MaxSettlementCost: 25,
    ladderV14VolumeFirstPairCost: 0.99,
    ladderV15EntryMinutesMax: 15,
    ladderV15EntryMinutesMin: 2,
    ladderV15CheapPrice: 0.1,
    ladderV15FavoritePrice: 0.8,
    ladderV15MinNetEdge: 0.03,
    ladderV15CycleShares: 40,
    ladderV15MaxUnmatchedPerMarket: 40,
    ladderV15MaxUnmatchedPortfolio: 120,
    ladderV15RetryLimit: 4,
    ladderV15RetryCooldownMs: 350,
    ladderV15CleanupSeconds: 30,
